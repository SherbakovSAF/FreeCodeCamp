...
// Не знаю почему, но моё идентичное решение он отказывается принимать, хотя оно точно такое же
// const usersOnline = this.state.users.filter(e => e.online == true); // Change this line
// const renderOnline = usersOnline.map(e => <li key={e.username}>{e}</li>); // Change this line
